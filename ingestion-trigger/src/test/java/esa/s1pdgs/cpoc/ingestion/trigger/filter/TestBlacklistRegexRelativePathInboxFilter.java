...
public class TestBlacklistRegexRelativePathInboxFilter {
	...
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forSession() {
		assertEquals(true, filterForSessions.accept(
	...
	public final void testAccept_OnMatchingRegex_ShallReturnFalse_forAux() {
		assertEquals(false,
				filterForAux.accept(new InboxEntry("foo.tmp", "foo.tmp", "file:///tmp/AUX/foo.tmp", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnMatchingRegex_ShallReturnFalse2_forAux() {
		assertEquals(false,
				filterForAux.accept(new InboxEntry(".foo.xml", ".foo.xml", "file:///tmp/AUX/.foo.xml", new Date(), 0)));
	}
	...
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forAux() {
		assertEquals(true,
				filterForAux.accept(new InboxEntry("fooxml", "fooxml", "file:///tmp/AUX/fooxml", new Date(), 0)));
	}
}
