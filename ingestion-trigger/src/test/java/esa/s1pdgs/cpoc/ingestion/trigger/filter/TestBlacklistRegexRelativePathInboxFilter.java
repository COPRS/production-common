...
public class TestBlacklistRegexRelativePathInboxFilter {
	...
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forSession() {
		assertTrue(filterForSessions.accept(
				new InboxEntry("fooxml", "dir1/dir2/fooxml", "file:///tmp/MPS_/S1A/dir1/dir2/fooxml", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnMatchingRegex_ShallReturnFalse_forAux() {
		assertFalse(filterForAux.accept(new InboxEntry("foo.tmp", "foo.tmp", "file:///tmp/AUX/foo.tmp", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnMatchingRegex_ShallReturnFalse2_forAux() {
		assertFalse(filterForAux.accept(new InboxEntry(".foo.xml", ".foo.xml", "file:///tmp/AUX/.foo.xml", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnMatchingRegex_ShallReturnFalse3_forAux() {
		assertFalse(filterForAux
				.accept(new InboxEntry("foo.xml", "dir/foo.xml", "file:///tmp/AUX/dir/foo.xml", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnMatchingRegex_ShallReturnFalse4_forAux() {
		assertFalse(filterForAux
				.accept(new InboxEntry("foo", "dir1/dir2/foo", "file:///tmp/AUX/dir1/dir2/foo", new Date(), 0)));
	}

	@Test
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forAux() {
		assertTrue(filterForAux.accept(new InboxEntry("fooxml", "fooxml", "file:///tmp/AUX/fooxml", new Date(), 0)));
	}
}
