...
public class ArchiveStatusDto {
     ...
     * @param errorCounter
     */
    public ArchiveStatusDto(final AppState state, final long timeLastChange,
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
            ...
            ArchiveStatusDto other = (ArchiveStatusDto) obj;
            // field comparison
