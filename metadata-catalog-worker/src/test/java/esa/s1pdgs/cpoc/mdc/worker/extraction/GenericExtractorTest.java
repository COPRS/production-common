...
import esa.s1pdgs.cpoc.mdc.worker.extraction.GenericExtractor;
import esa.s1pdgs.cpoc.mdc.worker.extraction.LevelProductsExtractor;
...
public class GenericExtractorTest {
     ...
     * Extractor
     */
    protected GenericExtractor<ProductionEvent> extractor;
