package esa.s1pdgs.cpoc.ipf.preparation.trigger.tasks.l0slice;
...
public class L0SliceConsumerTest {
...
//            new GenericMessageDto<CatalogEvent>(2, "", dtoNotMatch);
    ...
    public void testReceiveOk() throws AbstractCodedException, ParseException {
        ...
        final L0SliceConsumer consumer = new L0SliceConsumer(l0SliceJobsDispatcher,
