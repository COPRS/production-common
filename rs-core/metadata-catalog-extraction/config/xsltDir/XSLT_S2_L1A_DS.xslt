<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="qualityInfo" select="//*[local-name() = 'Image_Data_Info']/*[local-name() = 'Sensor_Configuration']/*[local-name() = 'Source_Packet_Description']/*[local-name() = 'Degradation_Summary']/@degradationPercentage"/>
    ...
    <xsl:template match="/">
        ...
        <processorVersion>
           <xsl:value-of select="//*[local-name() = 'General_Info']/*[local-name() = 'Processing_Info']/*[local-name() = 'PROCESSING_BASELINE']"/>		
		</processorVersion>
