 ...
 */
public class MemoryConsumerAwareRebalanceListener<M extends AbstractMessage>
     ...
     */
    private final MessagePersistence<M> messagePersistence;
    ...
    public MemoryConsumerAwareRebalanceListener(
            final MessagePersistence<M> messagePersistence, final String group,
