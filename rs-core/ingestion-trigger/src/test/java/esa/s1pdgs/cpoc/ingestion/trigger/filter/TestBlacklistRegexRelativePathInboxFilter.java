...
public class TestBlacklistRegexRelativePathInboxFilter {
	...
	public final void testAccept_OnMatchingRegex_ShallReturnFalse2_forSession() {
		Assertions.assertFalse(this.filterForSessions.accept(new InboxEntry(".foo.xml", "dir1/dir2/.foo.xml",
	...
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forSession() {
		Assertions.assertTrue(this.filterForSessions
	...
	public final void testAccept_OnMatchingRegex_ShallReturnFalse_forAux() {
		Assertions.assertFalse(this.filterForAux.accept(new InboxEntry("foo.tmp", "foo.tmp", "file:///tmp/AUX/foo.tmp", new Date(),
	...
	public final void testAccept_OnMatchingRegex_ShallReturnFalse2_forAux() {
		Assertions.assertFalse(this.filterForAux.accept(new InboxEntry(".foo.xml", ".foo.xml", "file:///tmp/AUX/.foo.xml",
	...
	public final void testAccept_OnMatchingRegex_ShallReturnFalse3_forAux() {
		Assertions.assertFalse(this.filterForAux
	...
	public final void testAccept_OnNonMatchingRegex_ShallReturnTrue_forAux() {
		Assertions.assertTrue(this.filterForAux.accept(new InboxEntry("fooxml", "fooxml", "file:///tmp/AUX/fooxml", new Date(), 0,
