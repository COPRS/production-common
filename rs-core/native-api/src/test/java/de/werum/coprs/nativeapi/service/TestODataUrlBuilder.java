...
public class TestODataUrlBuilder {
	...
	public void testUrlBuilder() {
		...
		Assert.assertEquals(
				"http://s1pro-prip-frontend-svc.processing.svc.cluster.local:8080/odata/v1/Products%3Ffilter=ContentDate/Start%20gt%202010-10-18T14:33:00.000Z%20and%20ContentDate/End%20lt%202023-02-06T14:33:00.000%20and%20contains(Name,'S3A_PRODUCT')",
				url1);
		Assert.assertEquals(
