...
public class StandaloneApplication {
    public static void main(String[] args) {
    	 ...
    	 *    $ curl -XPUT "http://localhost:9200/prip" -H 'Content-Type: application/json' -d '{"mappings":{"metadata":{"properties":{"id":{"type":"text"},"obsKey":{"type":"text"},"name":{"type":"text"},"productFamily":{"type":"text"},"contentType":{"type":"text"},"contentLength":{"type":"long"},"contentDateStart":{"type":"date"},"contentDateEnd":{"type":"date"},"creationDate":{"type":"date"},"evictionDate":{"type":"date"},"checksum":{"type":"nested","properties":{"algorithm":{"type":"text"},"value":{"type":"text"}}}}}}}'
    	 *    
