...
//import static esa.s1pdgs.cpoc.prip.frontend.service.edm.EntityTypeProperties.Intersects;
...
//			properties.add(new CsdlProperty().setName(Intersects.name()).setType(FUNCTION_INTERSECTS_FQN));
