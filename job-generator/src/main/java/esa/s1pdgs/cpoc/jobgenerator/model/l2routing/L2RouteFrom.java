 ...
 *
 */
@XmlRootElement(name = "l2_from")
@XmlAccessorType(XmlAccessType.NONE)
public class L2RouteFrom {
	 ...
	 * @param satelliteId
	 */
	public L2RouteFrom(final String acquisition, final String satelliteId) {
		this();
	...
	public boolean equals(final Object obj) {
		...
		if (this == obj) {
			...
			L2RouteFrom other = (L2RouteFrom) obj;
