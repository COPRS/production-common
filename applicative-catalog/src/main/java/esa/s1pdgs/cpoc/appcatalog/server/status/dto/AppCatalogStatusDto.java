...
/**
 * Application catalog status
 *
 * @author Viveris Technologies
 */
public class AppCatalogStatusDto {
     ...
     * @param errorCounter
     */
    public AppCatalogStatusDto(final AppState state, final long timeLastChange,
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
            ...
            AppCatalogStatusDto other = (AppCatalogStatusDto) obj;
            // field comparison
