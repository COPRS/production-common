...
public class L0AcnMetadata extends AbstractMetadata {
	...
	public L0AcnMetadata(final String productName, final String productType, final String keyObjectStorage,
			final String validityStart, final String validityStop, final String missionId, final String satelliteId, final String stationId, final int instrumentConfigurationId,
