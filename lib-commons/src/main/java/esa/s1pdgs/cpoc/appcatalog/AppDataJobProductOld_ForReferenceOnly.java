 ...
 */
public class AppDataJobProductOld_ForReferenceOnly  {
     ...
     * 
     */
    public AppDataJobProductOld_ForReferenceOnly() {
        super();
     ...
     */
    public void setProcessMode(final String processMode) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
            ...
            final AppDataJobProductOld_ForReferenceOnly other = (AppDataJobProductOld_ForReferenceOnly) obj;
