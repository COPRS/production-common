 ...
 */
public class MqiGenericMessageDtoTest {
    ...
    public void testConstructors() {
        MqiGenericMessageDto<String> obj = new MqiGenericMessageDto<>();
        assertNull(obj.getDto());

        MqiGenericMessageDto<String> obj1 = new MqiGenericMessageDto<String>(
                ProductCategory.AUXILIARY_FILES);
        assertNull(obj1.getDto());
        assertEquals(ProductCategory.AUXILIARY_FILES, obj1.getCategory());

        MqiGenericMessageDto<String> obj2 = new MqiGenericMessageDto<String>(
        ...
        MqiGenericMessageDto<String> obj3 = new MqiGenericMessageDto<String>(
                ProductCategory.AUXILIARY_FILES, 1000, "topic-name", 2, 3210,
                "dto-object");
    ...
    public void testToString() {
        MqiGenericMessageDto<String> obj = new MqiGenericMessageDto<String>(
                ProductCategory.AUXILIARY_FILES, 1000, "topic-name", 2, 3210,
                "dto-object");
    ...
    public void testEquals() {
        EqualsVerifier.forClass(MqiGenericMessageDto.class).usingGetClass()
