...
- RS-1034: [BUG] OBS requests always use HTTP, adding flag to enforce HTTPS for OBS. By default activated in PRIP Frontend as UWC #922 requires it.

### Changed

- RS-685: [BUG] [OPS] RS-Core Ingestion trigger failed to send list of detected chunk in Kafka
- RS-1002: [BUG] [Metadata v1.13.2-rc1] Fails to extract 1 specific SL_1 and 1 SL_2 product generated by PUG
- RS-1015: [BUG] Many connection refused for RS CORE compression, increasing timeout between obs retries
- RS-1024: Update S3_L0 CFI - ACQ to version 3.4.38
...
- RS-1019: Disable the github actions for SM2_HY, SM2_LI and SM2_SI image building
- RS-1020: Remove Java advance imaging library dependencies
...
- RS-1017: [BUG] [METADATA EXTRACTION] Metadata extraction do not provide information for some S3 products
