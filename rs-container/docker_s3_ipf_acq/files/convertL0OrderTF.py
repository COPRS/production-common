...
def createTelemetryOutput(root, filename, satelliteId, downlinkorbitnumber):
    ...
    pathname1.text = '/data/NRTAP/WorkingDir/S3' + satelliteId + '/' + downlinkorbitnumber + '/2'
    ...
    pathname2.text = '/data/NRTAP/WorkingDir/S3' + satelliteId + '/' + downlinkorbitnumber + '/2'
