...
public class AppStatus {
     ...
     * Service state
     */
    private final PripStatus status;
     ...
     * @return the status
     */
    public synchronized PripStatus getStatus() {
        return status;
    }
    ...
    public synchronized void setError(String type) {
    	this.status.incErrorCounter(maxErrorCounter);
    }
    ...
    public class PripStatus {
         ...
         */
        public void incErrorCounter(final int maxErrorCounter) {
            if (!isStopping()) {
