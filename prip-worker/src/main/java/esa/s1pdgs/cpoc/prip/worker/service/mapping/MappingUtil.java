package esa.s1pdgs.cpoc.prip.worker.service.mapping;

import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.Algorithm;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.Checksums;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.ContentLength;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.ContentType;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.CreationDate;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.EvictionDate;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.Id;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.Name;
import static esa.s1pdgs.cpoc.prip.worker.service.edm.EntityTypeProperties.Value;
