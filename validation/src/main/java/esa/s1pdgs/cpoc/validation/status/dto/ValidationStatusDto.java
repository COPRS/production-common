package esa.s1pdgs.cpoc.validation.status.dto;
...
public class ValidationStatusDto {
    ...
    public ValidationStatusDto(final AppState state, final long timeLastChange,
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
        	...
        	ValidationStatusDto other = (ValidationStatusDto) obj;
            // field comparison
