...
COPRS Metadata chain is responsible for extrating metadata from the products related to the missions of COPRS system and persist the information in Metadata Catalog (ES).
