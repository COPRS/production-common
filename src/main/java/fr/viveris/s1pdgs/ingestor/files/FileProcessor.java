...
import fr.viveris.s1pdgs.ingestor.files.services.FileDescriptorBuilder;
...
import fr.viveris.s1pdgs.ingestor.s3.ConfigFilesS3Services;
import fr.viveris.s1pdgs.ingestor.s3.SessionFilesS3Services;
import fr.viveris.s1pdgs.ingestor.s3.exceptions.AlreadyExistObjectStorageException;
...
public class FileProcessor {
	 ...
	 */
	@Autowired
	KafkaConfigFileProducer senderConfigFiles;
			...
			try {
				...
				try {
					...
					if (descriptor.isHasToBePublished()) {
						...
						senderConfigFiles.send(fileToIndex);
					}
