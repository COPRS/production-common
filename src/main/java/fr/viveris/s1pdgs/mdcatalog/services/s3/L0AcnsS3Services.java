...
@Service
public class L0AcnsS3Services implements S3Services {

	private static final Logger LOGGER = LoggerFactory.getLogger(L0AcnsS3Services.class);

	@Autowired
	private AmazonS3 s3client;

	@Value("${storage.buckets.acns}")
