...
public class L0SliceDto {
	/**
	 * Product name of the L0 Slices
	 */
	private String productName;
	
	/**
	 * ObjectkeyStorage of the L0 Slices
	 */
	 ...
	 */
	public L0SliceDto(String productName, String keyObjectStorage, String familyName) {
		this();
	...
	public String toString() {
		return "L0SliceDto [productName=" + productName + ", keyObjectStorage=" + keyObjectStorage + ", familyName="
				+ familyName + "]";
	}
