...
public class KafkaConfig {
    ...
    private static final Logger LOGGER =
            LogManager.getLogger(KafkaConfig.class);
    ...
    public ConsumerFactory<String, JobDto> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(),
                new StringDeserializer(), new JsonDeserializer<>(JobDto.class));
    }
                ...
                new ConsumerAwareRebalanceListener() {
                    ...
                    public void onPartitionsRevokedBeforeCommit(
                        ...
                        if (!CollectionUtils.isEmpty(pausedP)) {
                            isPaused = true;
                            LOGGER.info(
                                    "onPartitionsRevokedBeforeCommit call paused = true");
                        } else {
                            isPaused = false;
                            LOGGER.info(
                                    "onPartitionsRevokedBeforeCommit call paused = false");
                        }
                    }
                    ...
                    public void onPartitionsRevokedAfterCommit(
                        ...
                        if (!CollectionUtils.isEmpty(pausedP)) {
                            isPaused = true;
                            LOGGER.info(
                                    "onPartitionsRevokedAfterCommit call paused = true");
                        } else {
                            isPaused = false;
                            LOGGER.info(
                                    "onPartitionsRevokedAfterCommit call paused = false");
                        }
                    }
                    ...
                    public void onPartitionsAssigned(Consumer<?, ?> consumer,
                        ...
                        if (isPaused) {
                            LOGGER.info(
                                    "onPartitionsAssigned call set pause = true");
