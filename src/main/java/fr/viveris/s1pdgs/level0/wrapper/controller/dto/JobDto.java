...
public class JobDto {
     ...
     */
    public JobDto(final String productIdentifier, final String workDirectory,
    ...
    public String toString() {
        return String.format(
                ...
                productIdentifier, workDirectory, jobOrder, inputs, outputs,
                pools);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(productIdentifier, workDirectory, jobOrder, inputs,
                outputs, pools);
    }
