 ...
 */
public class AppCatalogMqiAckApiError extends AbstractCodedException {
     ...
     * @param message
     */
    public AppCatalogMqiAckApiError(final ProductCategory category,
            final String uri, final Object dto, final String message) {
        super(ErrorCode.APPCATALOG_MQI_ACK_API_ERROR, message);
    ...
    public AppCatalogMqiAckApiError(final ProductCategory category,
        ...
        super(ErrorCode.APPCATALOG_MQI_ACK_API_ERROR, message, cause);
        this.category = category;
        this.uri = uri;
        this.dto = dto;
    }
