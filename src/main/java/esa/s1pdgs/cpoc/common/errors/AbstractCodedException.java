...
public abstract class AbstractCodedException extends Exception {
    ...
    public enum ErrorCode {
        ...
        JOB_GEN_METADATA_ERROR(278), STATUS_PROCESSING_API_ERROR(279),
        ...
        APPCATALOG_MQI_READ_API_ERROR(340), APPCATALOG_MQI_NEXT_API_ERROR(341),
        APPCATALOG_MQI_SEND_API_ERROR(342), APPCATALOG_MQI_ACK_API_ERROR(343),
        APPCATALOG_MQI_GET_OFFSET_API_ERROR(344);
