...
/**
 * DTO class for ingestor status
 *  
 * @author Viveris Technologies
 */
public class IngestorStatusDto {
     ...
     * @param errorCounter
     */
    public IngestorStatusDto(final AppState state, final long timeLastChange,
    ...
    public boolean equals(final Object obj) {
        ...
        if (this == obj) {
            ...
            IngestorStatusDto other = (IngestorStatusDto) obj;
            // field comparison
