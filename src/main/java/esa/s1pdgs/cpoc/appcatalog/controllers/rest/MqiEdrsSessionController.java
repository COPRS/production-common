...
public class MqiEdrsSessionController
    ...
    public ResponseEntity<MqiLightMessageDto> readMessage(
            ...
            @RequestBody final MqiGenericReadMessageDto<EdrsSessionDto> body) {
    ...
    public ResponseEntity<List<MqiGenericMessageDto<EdrsSessionDto>>> next(
    ...
    public ResponseEntity<MqiGenericMessageDto<EdrsSessionDto>> ackMessage(
            @PathVariable(name = "messageID") final long messageID,
