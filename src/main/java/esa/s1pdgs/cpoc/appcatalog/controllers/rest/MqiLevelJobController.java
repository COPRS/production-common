...
public class MqiLevelJobController extends GenericMqiController<LevelJobDto> {
    ...
    public ResponseEntity<MqiLightMessageDto> readMessage(
            ...
            @RequestBody final MqiGenericReadMessageDto<LevelJobDto> body) {
    ...
    public ResponseEntity<List<MqiGenericMessageDto<LevelJobDto>>> next(
    ...
    public ResponseEntity<MqiGenericMessageDto<LevelJobDto>> ackMessage(
            @PathVariable(name = "messageID") final long messageID,
