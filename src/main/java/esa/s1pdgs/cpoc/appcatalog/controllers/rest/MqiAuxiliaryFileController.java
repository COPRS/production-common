...
public class MqiAuxiliaryFileController
    ...
    public ResponseEntity<MqiLightMessageDto> readMessage(
            ...
            @RequestBody final MqiGenericReadMessageDto<AuxiliaryFileDto> body) {
    ...
    public ResponseEntity<List<MqiGenericMessageDto<AuxiliaryFileDto>>> next(
    ...
    public ResponseEntity<MqiGenericMessageDto<AuxiliaryFileDto>> ackMessage(
            @PathVariable(name = "messageID") final long messageID,
