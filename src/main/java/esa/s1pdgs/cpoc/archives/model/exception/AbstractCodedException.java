...
public abstract class AbstractCodedException extends Exception {
    ...
    public enum ErrorCode {
        ...
        OBS_UNKOWN_OBJ(50), OBS_ERROR(51), MAX_NUMBER_CACHED_JOB_REACH(270),
        MAX_NUMBER_TASKTABLE_REACH(271), MAX_NUMBER_CACHED_SESSIONS_REACH(272),
        MAX_AGE_CACHED_JOB_REACH(273), MAX_AGE_CACHED_SESSIONS_REACH(274),
        MISSING_ROUTING_ENTRY(275), JOB_GENERATOR_INIT_FAILED(276),
        MISSING_INPUT(277), KAFKA_SEND_ERROR(70), KAFKA_RESUMING_ERROR(71),
        KAFKA_PAUSING_ERROR(72), KAFKA_COMMIT_ERROR(73);
