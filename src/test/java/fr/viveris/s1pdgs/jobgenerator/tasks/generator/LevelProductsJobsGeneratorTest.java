...
import fr.viveris.s1pdgs.jobgenerator.model.JobGeneration;
...
public class LevelProductsJobsGeneratorTest {
    ...
    private JobGeneration<LevelProductDto> jobA;

    private AppDataJobDto<LevelProductDto> appDataJob;

    private AppDataJobDto<LevelProductDto> appDataJobComplete;
    ...
    public void init() throws Exception {
        ...
        generator = (LevelProductsJobsGenerator) factory
                .createJobGeneratorForL0Slice(new File(
