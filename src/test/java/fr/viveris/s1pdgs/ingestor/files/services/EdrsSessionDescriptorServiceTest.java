...
public class EdrsSessionDescriptorServiceTest {
	...
	@Before
	public void init() {
		service = new EdrsSessionFileDescriptorService(FileUtils.TEST_DIR_ABS_PATH_SEP);
	}
	...
	public void testPattern() {
		checkMatchOk("S1A/707000125/ch01/DCS_02_L20171109175634707000125_ch1_DSDB_00001.raw");
		checkMatchOk("S1B/707000180/ch02/DCS_02_L20171109175634707000180_ch1_DSIB.xml");
		...
		checkMatchKo("S1B/707000180/ch01/");
		checkMatchKo("S1B/707000180/ch01/DCS_02_L20171109175634707000181_ch1_DSIB.xml");
		checkMatchKo("S1B/707000180/ch03/DCS_02_L20171109175634707000180_ch1_DSIB.xml");
	}
	...
	public void testBuildDescriptorWhenNoMatch() throws FilePathException {
		...
		thrown.expect(hasProperty("productName", is(FileUtils.RPATH_SESSION_NO_MATCH)));
		thrown.expect(hasProperty("path", is(FileUtils.RPATH_SESSION_NO_MATCH)));
	...
	public void testBuildDescriptor() throws FilePathException {
		...
		assertEquals("Invalid file descriptor for RPATH_SESSION_RAW",
				FileUtils.getFileDescriptorForEdrsSession(FileUtils.RPATH_SESSION_RAW),
				service.buildDescriptor(FileUtils.RPATH_SESSION_RAW));
		assertEquals("Invalid file descriptor for RPATH_SESSION_XML",
				FileUtils.getFileDescriptorForEdrsSession(FileUtils.RPATH_SESSION_XML),
	 ...
	 */
	@Test
	public void testBuildDescriptorForIif() throws FilePathException {
		thrown.expect(FilePathException.class);
		thrown.expect(hasProperty("productName", is(FileUtils.RPATH_SESSION_XML_IIF)));
