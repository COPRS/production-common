...
@SpringBootTest
@DirtiesContext
public class MqiAuxiliaryFileControllerTest extends RestControllerTest {
    ...
    public void testReadMessageMqiMessageDontExists() throws Exception {
        ...
        MqiGenericReadMessageDto<AuxiliaryFileDto> body = 
                new MqiGenericReadMessageDto<AuxiliaryFileDto>("group","readingPod",false, null);
    ...
    public void testReadMessageMqiMessageForce() throws Exception {
        ...
        this.mockSearchByTopicPartitionOffsetGroup(response);
        MqiGenericReadMessageDto<AuxiliaryFileDto> body = 
                new MqiGenericReadMessageDto<AuxiliaryFileDto>("group","readingPod",true, null);
        request(post("/mqi/auxiliary_files/topic/1/5/read")
                .contentType(MediaType.APPLICATION_JSON_VALUE).content(convertObjectToJsonString(body)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE));
    ...
    public void testNextMessageMqiMessageDontExists() throws Exception {
        ...
        request(get("/mqi/auxiliary_files/next")
