...
public class AppCatalogMqiEdrsSessionsServiceTest {
    ...
    private EdrsSessionDto dto =
            new EdrsSessionDto("key-obs", 1, EdrsSessionFileType.SESSION, "S1", "A");
    ...
    public void testMaxRetries() throws AbstractCodedException {
        ...
        try {
            ...
            verify(restTemplate, times(2)).exchange(
                    Mockito.eq("uri/mqi/edrs_sessions/next"),
    ...
    public void testNext1() throws AbstractCodedException {
        ...
        List<MqiGenericMessageDto<EdrsSessionDto>> result = service.next();
    ...
    public void testAckWhenNoResponse() throws AbstractCodedException {
        ...
        thrown.expect(
                hasProperty("category", is(ProductCategory.EDRS_SESSIONS)));
        thrown.expect(
                hasProperty("uri", is("uri/mqi/edrs_sessions/1234/ack")));
    ...
    public void testAck1() throws AbstractCodedException {
        ...
        MqiGenericMessageDto<EdrsSessionDto> ret = service.ack(1234);
        assertEquals(ret, message1);
        verify(restTemplate, times(2)).exchange(
                Mockito.eq("uri/mqi/edrs_sessions/1234/ack"),
