 ...
 */
public class LevelJobProducerTest {
     ...
     */
    @Mock
    private KafkaTemplate<String, LevelJobDto> template;

    @Mock
    private ListenableFuture<SendResult<String, LevelJobDto>> future;

    /**
     * Publisher to test
     */
    private LevelJobProducer producer;

    /**
     * DTO to send
     */
    private LevelJobDto dto;
