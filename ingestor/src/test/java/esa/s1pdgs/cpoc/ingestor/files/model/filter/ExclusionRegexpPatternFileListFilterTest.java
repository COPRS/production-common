...
public class ExclusionRegexpPatternFileListFilterTest {
	...
	public void init() throws IOException {
		fileWriting = new File("target/S1A_OPER_AUX_OBMEMC_PDMC_20140201T000000.xml.writing");
		fileMpeg = new File("target/S1A_OPER_AUX_OBMEMC_PDMC_20140201T000000.mpeg");
		fileHidden = new File("target/.S1A_OPER_AUX_OBMEMC_PDMC_20140201T000000.xml");
		fileOk = new File("target/S1A_OPER_AUX_OBMEMC_PDMC_20140201T000000.xml");
	...
	public void testAccept() {
		...
		File file = new File("target/log4j2-test.yml");
	...
	public void testGetFilename() {
		...
		assertEquals("target", filter.getFilename(dir));
