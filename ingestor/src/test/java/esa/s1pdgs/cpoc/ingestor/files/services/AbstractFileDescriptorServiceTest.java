...
public class AbstractFileDescriptorServiceTest {
     ...
     * Root directory for tests
     */
    private File child1Dir =
            new File(TEST_DIR_PATH + "/file_descriptor/child1");

    /**
     * File
     */
    private File file1 =
            new File(TEST_DIR_PATH + "/file_descriptor/child1/file1.txt");
    ...
    public void testGettersConstrucotrs() {
        FileDescriptorServiceImpl service =
                new FileDescriptorServiceImpl("dir", "fam");
     ...
     */
    @Test
    public void testExtractDescriptorDirectory()
            throws IngestorFilePathException, IngestorIgnoredFileException {
        FileDescriptorServiceImpl service = new FileDescriptorServiceImpl(
                FileUtils.TEST_DIR_ABS_PATH_SEP, "fam");

        thrown.expect(IngestorIgnoredFileException.class);
     ...
     */
    @Test
    public void testExtractDescriptorFileOk()
            throws IngestorFilePathException, IngestorIgnoredFileException {
        FileDescriptorServiceImpl service = new FileDescriptorServiceImpl(
                FileUtils.TEST_DIR_ABS_PATH_SEP, "fam");

        FileDescriptor desc1 = service.extractDescriptor(file1);
        assertEquals("file_descriptor/child1/file1.txt",
                desc1.getRelativePath());
     ...
     */
    @Test
    public void testExtractDescriptorFileNotInDirectory()
            throws IngestorFilePathException, IngestorIgnoredFileException {
        FileDescriptorServiceImpl service = new FileDescriptorServiceImpl(
                FileUtils.TEST_DIR_ABS_PATH_SEP, "fam");
...
class FileDescriptorServiceImpl extends AbstractFileDescriptorService {
     ...
     */
    @Override
    protected FileDescriptor buildDescriptor(String relativePath)
