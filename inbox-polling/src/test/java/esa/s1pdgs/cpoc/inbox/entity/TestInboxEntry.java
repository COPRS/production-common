...
public class TestInboxEntry {
	...
	public final void testGetName_OnValidName_ShallReturnName() {
		final InboxEntry uut = factory.newInboxEntry(new InboxPathInformation(), "/tmp/fooBar");
		assertEquals("fooBar", uut.getName());
	}

	@Test
	public final void testHashCode_OnSameObject_ShallReturnSameHashCode() {
		final InboxEntry uut1 = factory.newInboxEntry(new InboxPathInformation(), "/tmp/fooBar");
		final InboxEntry uut2 = factory.newInboxEntry(new InboxPathInformation(), "/tmp/fooBar");
		assertEquals(uut1.hashCode(), uut2.hashCode());
	}

	@Test
	public final void testHashCode_OnDifferentObject_ShallReturnDifferentHashCode() {
		final InboxEntry uut1 = factory.newInboxEntry(new InboxPathInformation(), "/tmp/foo");
		final InboxEntry uut2 = factory.newInboxEntry(new InboxPathInformation(), "/tmp/bar");
